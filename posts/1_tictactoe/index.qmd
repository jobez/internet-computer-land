...
return wallet ? (new starknetjs.Contract(abi, "0x02386219c8ca466b820f56426c444b8eb157156d49795eaaeb37f9dbdf589430",
wallet.account)) : null
...
```{ojs}
txn_status = pollTxn(txn_state, 1000)
```
...
c_game_state = {
       ...
       return [game_id.game_idx, game_state]
